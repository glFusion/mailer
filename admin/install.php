...
if (!SEC_inGroup('Root')) {
    ...
    COM_errorLog("Someone has tried to illegally access the Mailer Plugin install/uninstall page.  User id: {$_USER['uid']}, Username: {$_USER['username']}, IP: $REMOTE_ADDR",1);
